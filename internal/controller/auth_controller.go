...
func (c *AuthController) Login(w http.ResponseWriter, r *http.Request) {
	...
	if !decodeAndValidateJSON(w, r, c.maxBytes, &req, func(d *dto.LoginRequest) { d.Sanitize() }, req.Validate) {
		return
	}
...
func (c *AuthController) ForgotPassword(w http.ResponseWriter, r *http.Request) {
	...
	if !decodeAndValidateJSON(w, r, c.maxBytes, &req, func(d *dto.ForgotPasswordRequest) { d.Sanitize() }, req.Validate) {
		return
	}
...
func (c *AuthController) ResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	if !decodeAndValidateJSON(w, r, c.maxBytes, &req, func(d *dto.ResetPasswordRequest) { d.Sanitize() }, req.Validate) {
		return
	}
